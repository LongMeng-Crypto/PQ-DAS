...
pub fn field_representation(instr: &Instruction) -> [F; N_INSTRUCTION_COLUMNS] {
    ...
    match instr {
        Instruction::Computation {
            ...
            match operation {
                Operation::Add => {
                    fields[instr_idx(EXEC_COL_AUX_1)] = F::ONE; // ADD = P_1(aux_1=1) = 1
                }
                Operation::Mul => {
                    fields[instr_idx(EXEC_COL_FLAG_MUL)] = F::ONE;
                }
            }
        ...
        Instruction::Jump {
            ...
            fields[instr_idx(EXEC_COL_FLAG_JUMP)] = F::ONE;
        ...
        Instruction::Precompile(precompile) => {
            let domainsep = match &precompile.data {
                ...
                PrecompileCompTimeArgs::PqDasMembershipBatch { .. } => PQ_DAS_MEMBERSHIP_DOMAINSEP,
                PrecompileCompTimeArgs::PqDasCommitment { .. } => PQ_DAS_COMMITMENT_DOMAINSEP,
            };
