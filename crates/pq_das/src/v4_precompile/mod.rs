...
/// Encodes extension-field data and constructs V4-precompile's row digests and column-root commitment.
...
fn guest_source() -> ProgramSource {
    ProgramSource::Raw(include_str!("../../zkdsl/v4_precompile/full.py").to_string())
}
...
/// Proves V4-precompile's cell-first commitment and extension-field RS dot-product statement.
...
/// Verifies a LeanVM proof against an already rebuilt V4-precompile statement.
